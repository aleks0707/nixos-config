...
$ qemu-system-x86_64 -m 1G,slots=3,maxmem=4G -smp 2 -netdev user,id=netdev0,hostfwd=22 -device e1000,netdev=netdev0 -hda nixos.img -cdrom nixos-minimal.iso -rtc base=localtime -accel hax
```
